...
paymeLaterApp.factory('Account', ['$resource',
    function ($resource) {
...
paymeLaterApp.factory('Sessions', ['$resource',
    function ($resource) {
...
paymeLaterApp.factory('ThreadDumpService', ['$http',
    function ($http) {
        return {
            dump: function() {
...
paymeLaterApp.factory('AuditsService', ['$http',
    function ($http) {
        return {
            findAll: function() {
...
paymeLaterApp.factory('Session', ['$cookieStore',
...
paymeLaterApp.constant('USER_ROLES', {
        all: '*',
        admin: 'ROLE_ADMIN',
        user: 'ROLE_USER'
    });

paymeLaterApp.factory('AuthenticationSharedService', ['$rootScope', '$http', '$cookieStore', 'authService', 'Session', 'Account',
